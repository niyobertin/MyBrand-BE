...
usersRoutes.post("/users/admin/login", usersController_1.default.adminLogin);
usersRoutes.get("/users", authMiddleware_1.authoticateAdmin, usersController_1.default.allusers);
