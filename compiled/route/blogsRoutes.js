...
blogsRoutes.patch('/:id', authMiddleware_1.authotication, authMiddleware_1.authoticateAdmin, muliter_1.fileUpload.single('image'), blogsController_1.default.updatedBlogs);
